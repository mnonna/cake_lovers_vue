<template>
  <b-container class="cl-cakes" fluid id="cakes">
    <div class="cl-cakes__main">
      <div class="cl-cakes__heading">
...
<script>
const CakeSlider = () => import("./slider/CakesSlider");
export default {
  components: {
    CakeSlider
  }
